...
{
    /// <summary>Initializes a new instance of the Pattern class with the specified name and style.</summary>
    ...
    /// </summary>
    /// <returns>The regular expression pattern as a string.</returns>
